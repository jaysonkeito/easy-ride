...
<div class="panel">
    ...
    <div class="account-info">
        ...
        <div class="account-item">
            ...
            <div class="account-value">
                <a href="StudentEditAccount.jsp" class="edit-button"><i class="fas fa-edit" style="margin-right: 6px;"></i>Edit</a>
            </div>
        </div>
    </div>
    ...
    <div class="support-logout">
        <button onclick="location.href='StudentSupport.jsp'">Support</button>
        <button onclick="location.href='StudentLogoutServlet'">Log Out</button>
    </div>
</div>
...
<div class="navbar">
    ...
    <a href="StudentAccount.jsp" class="nav-item active">
